<?php
require_once(dirname(__FILE__).'../../../models/archival_management/archival_management_model.php');
	 ...
	 public function operation($operation,$data){
		...
		switch ($operation) {
                    case "list":
                        ...
                        $data['category_root_id'] = $archival_management_model->get_category_root($data['collection_id']);
