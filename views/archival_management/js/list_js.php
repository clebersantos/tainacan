...
function export_classification_plan(){
    ...
    if($("#category_id_archival_management").val()!==''){
        ...
        window.location = $('#src').val() + '/controllers/archival_management/archival_management_controller.php'+get;
    }else{
         $('#modaldynatreeExportPlan').modal('hide');
 ...
 */
 function list_export_items(){
     ...
     $.ajax({
            type: "POST",
            url: $('#src').val()+"/controllers/archival_management/archival_management_controller.php",
