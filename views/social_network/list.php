    ...
    <div class="col-md-10" id="list_social_network">
        <div class="row">
            ...
            <ul class="nav nav-tabs">
                ...
                <li role="presentation"><a href="#aba-faceboook-mapping" aria-controls="property_object_tab" role="tab" data-toggle="tab"><?php _e('Facebook', 'tainacan') ?></a></li>
            ...
            <div class="tab-content">
                ...
                <!-- Aba do facebook-->
                <div id="aba-faceboook-mapping" class="tab-pane fade">
                    ...
                    <input type="button" onclick="edit_mapping('facebook')" id="btn_mapping_facebook" name="btn_mapping_facebook" class="btn btn-primary" value="<?php _e('Edit Facebook Mapping', 'tainacan'); ?>" /><br><br>
                ...
                <div id="aba-vimeo-mapping" class="tab-pane fade">
                    ...
                    <input type="button" onclick="edit_mapping('vimeo')" id="btn_mapping_vimeo" name="btn_mapping_vimeo" class="btn btn-primary" value="<?php _e('Edit Vimeo Mapping', 'tainacan'); ?>" /><br><br>
                    <!--label for="instagram_identifiers"><?php _e('Entry an user name from a instagram profile', 'tainacan'); ?></label>
                    <input type="text"  name="instagram_identifiers" id="instagram_identifier_input" style="width: 33.333%" placeholder="Digite aqui" class="form-control"/></br>
                    <input type="button" id="btn_identifiers_instagram" name="addChannel" class="btn btn-default pull-left" value="Adicionar"  />
                    <input type="button" id="btn_identifiers_instagram_update" name="updateInstagramProfileIdentifier" class="btn btn-default pull-left" value="Salvar Edição" />
