...
<ol class="breadcrumb" style="margin-top: -10px; padding-left: 0; background: #f2f2f2">
<!--    <button class="btn bt-default content-back" onclick="backToMainPageSingleItem()"><span class="glyphicon glyphicon-arrow-left"></span></button>-->
...
<div id="single_item_tainacan" class="col-md-12 no-padding">
    <div class="col-md-9 item-main-data" style="padding-right: 0;">
