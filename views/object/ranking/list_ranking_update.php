...
<div> 
    ...
    <?php if (!isset($likes) && !isset($binaries) && !isset($stars)): ?>
        ...
        <div id="update_no_rankings_<?php echo $object_id; ?>">
            <?php _e('No rankings available','tainacan'); ?>
        </div>-->
    <?php else: ?>
         <!-- TAINACAN: mostra os rankings do tipo estrela -->
        <div id="update_stars_<?php echo $object_id; ?>">
            <?php if (isset($stars)): ?>    
        ...
        <div id="update_likes_<?php echo $object_id; ?>">
            <?php if (isset($likes)): ?>    
        ...
        <div id="update_binaries_<?php echo $object_id; ?>">
