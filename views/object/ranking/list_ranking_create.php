...
<div> 
    ...
    <?php if (!isset($likes) && !isset($binaries) && !isset($stars)): ?>
        ...
        <div id="create_no_rankings_<?php echo $object_id; ?>">
            <?php _e('No rankings available','tainacan'); ?>
        </div>-->
    <?php else: ?>
         <!-- TAINACAN: mostra os rankings do tipo estrela -->
        <div id="create_stars_<?php echo $object_id; ?>">
            <?php if (isset($stars)): ?>    
        ...
        <div id="create_likes_<?php echo $object_id; ?>">
            <?php if (isset($likes)): ?>    
                <?php foreach ($likes as $like) { ?>
                    ...
                    <br>
                    <a style="text-decoration: none;font-size: 20px;" onclick="create_save_vote_like( '<?php echo $like['id']; ?>', '<?php echo $object_id; ?>')" href="#">
                        <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>
                    </a>
                    <span id="create_counter_<?php echo $object_id; ?>_<?php echo $like['id']; ?>"><?php echo $like['count'] ?></span><br>
                <?php } ?>
            <?php endif; ?>
        </div>  
         <!-- TAINACAN: mostra os rankings do tipo like, icones do glyphicons  -->
        <div id="create_binaries_<?php echo $object_id; ?>">
